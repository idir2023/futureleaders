...
class DriveController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.drives.index', compact('drive'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('drives.index')->with('success', 'Drive option created successfully.');
    }
    ...
    public function update(Request $request, Drive $drive)
    {
        ...
        // Redirection vers la page d'index avec un message de succès
        return redirect()->route('drives.index')->with('success', 'Drive option updated successfully.');
    }
    ...
    public function destroy(Drive $drive)
    {
        ...
        // Redirection vers la page d'index avec un message de succès
        return redirect()->route('drives.index')->with('success', 'Drive option deleted successfully.');
    }
