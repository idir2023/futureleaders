                            ...
                            <tbody>
                                @forelse($consultations as $consultation)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-primary rounded-pill shadow-sm">Confirmation</button>

<button class="btn btn-sm btn-warning text-white rounded-pill shadow-sm">Pas complet</button>

<button class="btn btn-sm btn-success rounded-pill shadow-sm">Edit Lien Drive</button>

<button class="btn btn-sm btn-danger rounded-pill shadow-sm">Supprimer</button>
