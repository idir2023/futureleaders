...
@section('content')
    ...
    @else
        ...
        <div class="row">
            ...
            <div class="col-12 mt-3 d-flex justify-content-start align-items-center flex-column">
                <a class="btn btn-sm d-flex align-items-center" href="{{ route('home') }}" style="background: linear-gradient(45deg, #f4a300, #cba075); color: #fff; padding: 10px 20px; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); transition: background 0.3s ease, transform 0.2s ease;">
                    <i class="typcn typcn-arrow-back mr-1"></i> Retour à l'accueil
                </a>
            </div>
            ...
            <style>
                .btn:hover {
                    background: linear-gradient(45deg, #cba075, #f4acba075300);
