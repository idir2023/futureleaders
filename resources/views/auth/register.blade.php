...
<body>
    <div class="register-container">
        <form method="POST" action="{{ route('register') }}" class="register-form">
            ...
            @if (session('status'))
                <div class="notification status-message">{{ session('status') }}</div>
            @endif

            @if (session('success'))
                <div class="notification success-message">{{ session('success') }}</div>
            @endif
            ...
            <div class="form-group">
                ...
                <input id="name" name="name" type="text" class="form-control" placeholder="Entrez votre nom complet" value="{{ old('name') }}" required autocomplete="name">
            ...
            <div class="form-group">
                ...
                <input id="email" name="email" type="email" class="form-control" placeholder="Entrez votre email" value="{{ old('email') }}" required autocomplete="email">
                <svg class="form-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="form-row">
                <div class="form-col form-col-6">
                    <div class="form-group">
                        ...
                        <input id="telephone" name="telephone" type="tel" class="form-control" placeholder="Votre numéro" value="{{ old('telephone') }}" required autocomplete="tel">
                        <svg class="form-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="form-col form-col-6">
                    <div class="form-group">
                        ...
                        <input id="adresse" name="adresse" type="text" class="form-control" placeholder="Votre adresse" value="{{ old('adresse') }}" required autocomplete="street-address">
                        <svg class="form-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
