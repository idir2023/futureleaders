...
<body>
    <div class="container">
        {{-- <h1 class="title"><i class="fas fa-clipboard-list"></i> Consultation</h1> --}}
        ...
        <form action="{{ route('store-consultation') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="prix" name="prix" value="{{ $price }}" class="readonly"
                        readonly />
                </div>
            </div>
            ...
            <div class="input-row">
                <div class="form-group">
                    ...
                    <input type="text" id="telephone" name="telephone" value="{{ Auth::user()->telephone }}" placeholder="Ex: +212600000000" />
                </div>

                <div class="form-group">
                    <label for="adresse"><i class="fas fa-map-marker-alt"></i> Adresse</label>
                    <input type="text" id="adresse" name="adresse" value="{{ Auth::user()->adresse }}" placeholder="Votre adresse complète" />
                </div>
