                                            ...
                                            <?php if($clients->count() > 0): ?>
                                                <div class="d-flex flex-wrap gap-2">
                                                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                            $clients_count = \App\Models\User::where(
                                                                'parrain_id',
                                                                $client->id,
                                                            )->count();
                                                        ?>
                ...
                $(document).on('click', '.show-parrain-modal', function(e) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            targetDiv.html(
                                '<p class="text-danger">Erreur lors du chargement. Veuillez réessayer.</p>'
                            );
                        },
                        complete: function() {
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Aicha njimate\OneDrive\Bureau\futureleaders\resources\views/admin/ranks/index.blade.php ENDPATH**/ ?>